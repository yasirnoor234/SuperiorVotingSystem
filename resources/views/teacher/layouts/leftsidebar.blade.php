								...
								<ul class="nav nav-main">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="{{URL::to('teacher/events/create')}} ">
                                                 	Create Events
												</a>
											</li>
											<li>
												<a href="{{URL::to('teacher/events')}}">
													Show Event Details
												</a>
											</li>
											<li>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="{{URL::to('teacher/seminars/create')}} ">
													Create Seminars
												</a>
											</li>
											<li>
												<a href="{{URL::to('teacher/seminars')}}">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="{{URL::to('teacher/meetings/create')}} ">
													Create Meetings
												</a>
											</li>
											<li>
												<a href="{{URL::to('teacher/meetings')}}">
										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												...
												<div class="profile-info">
													<h4 class="name text-semibold">{{ Auth::guard('teacher')->user()->name }}</h4>
													<h5 class="role">{{ Auth::guard('teacher')->user()->email }}</h5>
													<div class="profile-footer">
														<a href="{{URL::to('teacher/profile')}}">(edit profile)</a>
													</div>
												</div>
											</div>
