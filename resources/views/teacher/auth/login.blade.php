...
<div class="signup-form">
    ...
    {{ csrf_field() }}
        ...
        <div class="clearfix">
            ...
            <a href="{{ route('teacher.password.request') }}" class="pull-right">Forgot Password?</a>
        </div>
    </form>
	<div class="text-center">Already have an account? <a href="{{route('teacher.register')}}">Register</a></div>
</div>
@endsection
