								...
								<ul class="nav nav-main">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="{{ url('student/event-details') }}">
                            						Show Event Details
												</a>
											</li>
										</ul>
									...
									<li class="nav-parent">
										<a>
											<i class="fa fa-tasks" aria-hidden="true"></i>											<span>Seminar Schedule</span>
										</a>
										<ul class="nav nav-children">
											<li>
												<a href="{{ url('student/seminar-details') }}">
									...
									<li class="nav-parent">
										<a>
											...
											<span>Time Schedule for Meeting</span>
										</a>
										<ul class="nav nav-children">
											<li>
												<a href="{{ url('student/meeting-details') }}">
									...
									<li>
										<a href="{{ url('student/feedbacks/create') }}">
										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												...
												<div class="profile-info">
													<h4 class="name text-semibold">{{ Auth::guard('student')->user()->name }}</h4>
													<h5 class="role">{{ Auth::guard('student')->user()->email }}</h5>
