						...
						<div class="col-md-6">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Best Details about Uers</h2>
						...
						<div class="col-md-6">
							<section class="panel">
								<header class="panel-heading">
									...
									<p class="panel-subtitle">It's easy to create custom graphs on User, there are several graph types that you can use, such as lines, bars, pie charts, etc...</p>
								</header>
								<div class="panel-body">
								...
								<div class="panel-body">
									<div class="row">
												...
												<h2>
													...
													<strong>
														<select class="form-control" id="salesSelector">
															<option value="JSOFT Admin" selected>Admin</option>
															<option value="JSOFT Drupal" >Teacher</option>
															<option value="JSOFT Wordpress" >Student</option>
														</select>
													</strong>
												</h2>
										...
										<div class="col-lg-4 text-center">
											<h2 class="panel-title mt-md">User Goal</h2>
											<div class="liquid-meter-wrapper liquid-meter-sm mt-lg">
												<div class="liquid-meter">
													<meter min="0" max="100" value="60" id="meterSales"></meter>
												</div>
												<div class="liquid-meter-selector" id="meterSalesSel">
													<a href="#" data-val="60" class="active">Monthly Goal</a>
													<a href="#" data-val="90">Annual Goal</a>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount">$ 1400.30</strong>
														</div>
													</div>
													<div class="summary-footer">
									...
									<section class="panel panel-featured-left panel-featured-tertiary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Today's Users</h4>
														<div class="info">
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount">1765</strong>
														</div>
													</div>
													<div class="summary-footer">
										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												...
												<div class="profile-info">
													<h4 class="name text-semibold">Yasir Noor</h4>
													...
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href="assets/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
																<img class="img-responsive" width="215" src="{{ asset('admin/assets/images/projects/project-4.jpg') }}">
																<span class="zoom">
